...
export function ConditionNode({ node, parentId }: ConditionNodeProps) {
  ...
  return (
    <div className="flex items-center gap-2 p-3 bg-white/60 backdrop-blur-sm border border-pink-200 rounded-xl shadow-sm hover:shadow-md transition-shadow">
      ...
      <button 
        ...
        className="p-1.5 text-pink-400 hover:text-red-500 hover:bg-pink-50 rounded-lg transition-colors ml-auto"
